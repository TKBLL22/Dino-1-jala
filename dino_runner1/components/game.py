...
from dino_runner1.components.obstacles.obstacle_manager import ObstacleManager
from dino_runner1.utils.text_utils import draw_message_component
from dino_runner1.components.powerups.power_up_manager import PowerUpManager
    ...
    def show_menu(self):
        ...
        if self.death_count == 0: 
           ...
           draw_message_component(
               ...
               self.screen,
               pos_y_center= half_scree_width - 100
            )
